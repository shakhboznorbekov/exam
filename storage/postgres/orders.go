...
func (f *OrderRepo) GetByPKey(ctx context.Context, pkey *models.OrderPrimaryKey) (*models.OrderList, error) {
...
func (f *OrderRepo) Delete(ctx context.Context, req *models.OrderPrimaryKey) error {
