...
type ProductRepoI interface {
	...
	GetByPKey(ctx context.Context, req *models.ProductPrimaryKey) (*models.Product, error)
...
type OrderRepoI interface {
	...
	GetByPKey(ctx context.Context, req *models.OrderPrimaryKey) (*models.OrderList, error)
